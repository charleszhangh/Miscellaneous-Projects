...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
        ...
        /*
         * creates number buttons from 0 to 9
         */
        for (int i = 0; i < 10; i++) {
        ...
        /*
         * goes through buttons 0 to 9 and adds action listeners
         */
        for (int i = 0; i < 10; i++) {
    ...
    public void updateTopDisplay(NaturalNumber n) {
        this.tTop.setText(n.toString()); //changes tTop text area to n
    }

    @Override
    public void updateBottomDisplay(NaturalNumber n) {
        this.tBottom.setText(n.toString()); //changes tBottom text area to n
    }
