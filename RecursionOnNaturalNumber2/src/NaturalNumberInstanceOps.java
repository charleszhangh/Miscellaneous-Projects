...
public final class NaturalNumberInstanceOps extends NaturalNumber2 {
    ...
    public void power(int p) {
        ...
        if (p >= 1) {
            if (p % 2 == 0) {
                NaturalNumber dummy2 = this.newInstance();
                this.power(p / 2);
                dummy2.copyFrom(this);
                this.multiply(dummy2);
            } else {
                NaturalNumber dummy2 = this.newInstance();
                NaturalNumber dummy3 = this.newInstance();
                dummy3.copyFrom(this);
                this.power(p / 2);
                dummy2.copyFrom(this);
                this.multiply(dummy2);
                this.multiply(dummy3);
            }
        } else {
            NaturalNumber dummy = new NaturalNumber2(1);
