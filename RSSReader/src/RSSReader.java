...
public final class RSSReader {
    ...
    private static void outputHeader(XMLTree channel, SimpleWriter out) {
        ...
        int descriptionElement = getChildElement(channel, "description"); //element index of description
        ...
        out.println("<p>" + channel.child(descriptionElement).child(0).label()
                + "</p>");
    ...
    private static void outputFooter(SimpleWriter out) {
        assert out != null : "Violation of: out is not null";
        assert out.isOpen() : "Violation of: out.is_open";
        out.println("</table> </body> </html>"); //closes all HTML tags
    }
    ...
    public static void main(String[] args) {
        ...
        out.println("Please input the URL of the RSS 2.0 Feed:");
        String url = in.nextLine();
        out.println("Please input the name of the HTML output file:");
        String outputName = in.nextLine();
        SimpleWriter fOut = new SimpleWriter1L(outputName);//creates new file
        ...
        out.println("Your HTML output file has been created.");
        in.close();
        out.close();
    }
